...
pygame.display.set_caption("Wall_Breaker of 80's")

font = pygame.font.SysFont('cascadia', 30)


bg = (255, 255, 255)

block_red = (238, 75, 43)
block_green = (57, 255, 20)
block_blue = (0, 255, 255)
...
while run:
	...
	if not live_ball:
		if game_over == 0:
			draw_text('CLICK ANYWHERE TO START !', font, text_col, 175, screen_height // 2 + 100)
		elif game_over == 1:
